...
export const financial: CategoryComplianceConfig = {
  ...
  prohibited: [
    ...
    // Timeline mandatory — "ช่วยคุณเก็บเงินล้านแรก" is a benign educational
    // headline; only "ล้านแรกใน 30 วัน" is regulator-flagged.
    { pattern: /ล้านแรก\s*ใน\s*\d+\s*(วัน|สัปดาห์|เดือน)/, label: "โฆษณาล้านแรกในเวลาที่กำหนด" },
